...
public class @DroneInput : IInputActionCollection, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        // Drone3
        m_Drone3 = asset.FindActionMap("Drone3", throwIfNotFound: true);
        m_Drone3_Move = m_Drone3.FindAction("Move", throwIfNotFound: true);
        m_Drone3_Throttle = m_Drone3.FindAction("Throttle", throwIfNotFound: true);
        m_Drone3_Yaw = m_Drone3.FindAction("Yaw", throwIfNotFound: true);
    }
    ...
    // Drone3
    private readonly InputActionMap m_Drone3;
    private IDrone3Actions m_Drone3ActionsCallbackInterface;
    private readonly InputAction m_Drone3_Move;
    private readonly InputAction m_Drone3_Throttle;
    private readonly InputAction m_Drone3_Yaw;
    public struct Drone3Actions
    {
        private @DroneInput m_Wrapper;
        public Drone3Actions(@DroneInput wrapper) { m_Wrapper = wrapper; }
        public InputAction @Move => m_Wrapper.m_Drone3_Move;
        public InputAction @Throttle => m_Wrapper.m_Drone3_Throttle;
        public InputAction @Yaw => m_Wrapper.m_Drone3_Yaw;
        public InputActionMap Get() { return m_Wrapper.m_Drone3; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(Drone3Actions set) { return set.Get(); }
        public void SetCallbacks(IDrone3Actions instance)
        {
            if (m_Wrapper.m_Drone3ActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnMove;
                @Throttle.started -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnThrottle;
                @Throttle.performed -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnThrottle;
                @Throttle.canceled -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnThrottle;
                @Yaw.started -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnYaw;
                @Yaw.performed -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnYaw;
                @Yaw.canceled -= m_Wrapper.m_Drone3ActionsCallbackInterface.OnYaw;
            }
            m_Wrapper.m_Drone3ActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Move.started += instance.OnMove;
                @Move.performed += instance.OnMove;
    ...
    public Drone3Actions @Drone3 => new Drone3Actions(this);
    ...
    public interface IDrone3Actions
    {
        void OnMove(InputAction.CallbackContext context);
        void OnThrottle(InputAction.CallbackContext context);
        void OnYaw(InputAction.CallbackContext context);
